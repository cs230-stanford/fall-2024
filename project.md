...
- [github repository](https://github.com/cs230-stanford/cs230-code-examples) with project code examples, including a computer vision and a natural language processing example (both in Tensorflow and Pytorch).
...
- A [sheet](https://docs.google.com/spreadsheets/d/1yzzoNnaKsV0vzLNwp-dAkEtFplvlaQGKcqu64cB3urs/edit#gid=0) of resources to get started with project ideas in several topics
